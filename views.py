...
class AddPasswordWindow:
    ...
    def add(self):
        ...
        """
        self.parent.database.append_password([0, self.url_entry.get(), self.username_entry.get(), self.password_entry.get()]) # Append the password to the database.
